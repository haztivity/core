...
export class HzNavbarComponent extends ComponentController {
    ...
    protected _onPageChangeEnd(e, newPage:INavigatorPageData, oldPage:INavigatorPageData) {
        ...
        page.off("."+HzNavbarComponent.NAMESPACE).on(`${PageController.ON_COMPLETE_CHANGE}.${HzNavbarComponent.NAMESPACE}`,{instance:instance},instance._onPageCompleteChange);
    }
