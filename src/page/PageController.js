    ...
    return {
        ...
        execute: function () {
            PageController = PageController_1 = (function () {
                ...
                PageController.prototype._prepareTemplate = function () {
                    var event = jquery_1.$.Event(PageController_1.ON_RENDERED);
